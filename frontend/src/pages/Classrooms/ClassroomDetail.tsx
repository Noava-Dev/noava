...
function ClassroomDetailPage() {
  ...
  const [showClassroomStatsModal, setShowClassroomStatsModal] = useState(false);
  ...
  return (
    <div className="flex min-h-screen bg-background-app-light dark:bg-background-app-dark">
      <div className="flex-1 w-full ml-0">
                ...
                <div className="flex flex-col items-center justify-between w-full gap-3 mt-6 sm:flex-row">
                  ...
                  <div className="flex flex-col w-full gap-3 sm:justify-end sm:flex-row">
                    ...
                    <Button
                      ...
                      onClick={() => setShowClassroomStatsModal(true)}>
                      <HiChartBar className="mr-2 size-5" />
                      {t('analytics.title')}
                    </Button>
                    {/* Members */}
                    <Button
        ...
        {/* Classroom Statistics Modal */}
        <ClassroomStatisticsModal
          show={showClassroomStatsModal}
          onClose={() => setShowClassroomStatsModal(false)}
          classroom={classroom}
        />
