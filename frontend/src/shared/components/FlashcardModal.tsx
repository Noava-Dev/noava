            ...
            {activeTab === "front" && (
              <div className="space-y-4 select-none">
                ...
                <div>
                  ...
                  <div className="flex mb-4 border-b border-border dark:border-border-dark">
                    <button
                      type="button"
                    ...
                    <button
                      ...
                      className={`inline-flex items-center gap-2 px-6 py-3 font-semibold select-none focus:outline-none focus:ring-0 hover:border-cyan-400 transition-colors bg-transparent ${
                        frontAudioTab === "record"
                          ? "text-cyan-400 border-b-2 border-cyan-400 bg-transparent"
                          : "text-text-muted-light dark:text-text-muted-dark bg-transparent"
                      }`}
                ...
                <div className="p-4 border rounded-lg border-border dark:border-border-dark bg-background-subtle-light dark:bg-background-subtle-dark">
            ...
            {activeTab === "back" && (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {/* Custom Back Audio Tabs Navigation */}
                  <div className="flex mb-4 border-b border-border dark:border-border-dark">
                    <button
                      type="button"
                      className={`inline-flex items-center gap-2 px-6 py-3 font-semibold select-none focus:outline-none focus:ring-0 hover:border-cyan-400 transition-colors bg-transparent ${
                      ...
                      onClick={() => setBackAudioTab("upload")}
                    >
                      <HiUpload className="size-4" />
                      {t("flashcardModal.uploadFile")}
                    </button>
                    ...
                    <button
                      ...
                      onClick={() => setBackAudioTab("record")}
                    >
                      <HiMicrophone className="size-4" />
                      {t("flashcardModal.recordAudio")}
                    </button>
