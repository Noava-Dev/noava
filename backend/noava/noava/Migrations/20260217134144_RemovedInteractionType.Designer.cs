...
namespace noava.Migrations
{
    ...
    [Migration("20260217134144_RemovedInteractionType")]
    partial class RemovedInteractionType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("noava.Models.Deck", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DeckId = 1,
                            CreatedAt = new DateTime(2026, 2, 17, 13, 41, 44, 139, DateTimeKind.Utc).AddTicks(1786),
                            Description = "Franse woorden voor beginners",
                            JoinCode = "",
                            Language = "Frans",
                            Title = "Frans Woordenschat",
                            UpdatedAt = new DateTime(2026, 2, 17, 13, 41, 44, 139, DateTimeKind.Utc).AddTicks(1787),
                        ...
                        {
                            DeckId = 2,
                            CreatedAt = new DateTime(2026, 2, 17, 13, 41, 44, 139, DateTimeKind.Utc).AddTicks(1789),
                            Description = "Engelse grammatica oefeningen",
                            JoinCode = "",
                            Language = "Engels",
                            Title = "Engels Grammatica",
                            UpdatedAt = new DateTime(2026, 2, 17, 13, 41, 44, 139, DateTimeKind.Utc).AddTicks(1790),
                            UserId = "user_38TGbnbcmzK7uZAbaABqTtzQtvz",
                            Visibility = 2
                        },
                        new
                        {
                            DeckId = 3,
                            CreatedAt = new DateTime(2026, 2, 17, 13, 41, 44, 139, DateTimeKind.Utc).AddTicks(1791),
                            Description = "Spaanse zinnen voor dagelijks gebruik",
                            JoinCode = "",
                            Language = "Spaans",
                            Title = "Spaans Conversatie",
                            UpdatedAt = new DateTime(2026, 2, 17, 13, 41, 44, 139, DateTimeKind.Utc).AddTicks(1792),
                            UserId = "user_38TGbnbcmzK7uZAbaABqTtzQtvz",
                            Visibility = 1
                        });
                });
