...
namespace noava.Migrations
{
    ...
    [Migration("20260218111342_RemoveFAQSeedData")]
    partial class RemoveFAQSeedData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("noava.Models.Deck", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DeckId = 1,
                            CreatedAt = new DateTime(2026, 2, 18, 11, 13, 41, 999, DateTimeKind.Utc).AddTicks(2681),
                            Description = "Franse woorden voor beginners",
                            JoinCode = "",
                            Language = "Frans",
                            Title = "Frans Woordenschat",
                            UpdatedAt = new DateTime(2026, 2, 18, 11, 13, 41, 999, DateTimeKind.Utc).AddTicks(2682),
                        ...
                        {
                            DeckId = 2,
                            CreatedAt = new DateTime(2026, 2, 18, 11, 13, 41, 999, DateTimeKind.Utc).AddTicks(2684),
                            Description = "Engelse grammatica oefeningen",
                            JoinCode = "",
                            Language = "Engels",
                            Title = "Engels Grammatica",
                            UpdatedAt = new DateTime(2026, 2, 18, 11, 13, 41, 999, DateTimeKind.Utc).AddTicks(2685),
                            UserId = "user_38TGbnbcmzK7uZAbaABqTtzQtvz",
                            Visibility = 2
                        },
                        new
                        {
                            DeckId = 3,
                            CreatedAt = new DateTime(2026, 2, 18, 11, 13, 41, 999, DateTimeKind.Utc).AddTicks(2687),
                            Description = "Spaanse zinnen voor dagelijks gebruik",
                            JoinCode = "",
                            Language = "Spaans",
                            Title = "Spaans Conversatie",
                            UpdatedAt = new DateTime(2026, 2, 18, 11, 13, 41, 999, DateTimeKind.Utc).AddTicks(2687),
                            UserId = "user_38TGbnbcmzK7uZAbaABqTtzQtvz",
                            Visibility = 1
                        });
                });
