...
namespace noava.Migrations
{
    ...
    [Migration("20260218101115_RemovedCardInteractionConstraint")]
    partial class RemovedCardInteractionConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("noava.Models.Deck", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DeckId = 1,
                            CreatedAt = new DateTime(2026, 2, 18, 10, 11, 15, 19, DateTimeKind.Utc).AddTicks(7641),
                            Description = "Franse woorden voor beginners",
                            JoinCode = "",
                            Language = "Frans",
                            Title = "Frans Woordenschat",
                            UpdatedAt = new DateTime(2026, 2, 18, 10, 11, 15, 19, DateTimeKind.Utc).AddTicks(7642),
                        ...
                        {
                            DeckId = 2,
                            CreatedAt = new DateTime(2026, 2, 18, 10, 11, 15, 19, DateTimeKind.Utc).AddTicks(7646),
                            Description = "Engelse grammatica oefeningen",
                            JoinCode = "",
                            Language = "Engels",
                            Title = "Engels Grammatica",
                            UpdatedAt = new DateTime(2026, 2, 18, 10, 11, 15, 19, DateTimeKind.Utc).AddTicks(7647),
                            UserId = "user_38TGbnbcmzK7uZAbaABqTtzQtvz",
                            Visibility = 2
                        },
                        new
                        {
                            DeckId = 3,
                            CreatedAt = new DateTime(2026, 2, 18, 10, 11, 15, 19, DateTimeKind.Utc).AddTicks(7651),
                            Description = "Spaanse zinnen voor dagelijks gebruik",
                            JoinCode = "",
                            Language = "Spaans",
                            Title = "Spaans Conversatie",
                            UpdatedAt = new DateTime(2026, 2, 18, 10, 11, 15, 19, DateTimeKind.Utc).AddTicks(7651),
                            UserId = "user_38TGbnbcmzK7uZAbaABqTtzQtvz",
                            Visibility = 1
                        });
                });
